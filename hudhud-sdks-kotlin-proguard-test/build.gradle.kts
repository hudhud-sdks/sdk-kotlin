...
dependencies {
    testImplementation(project(":hudhud-sdks-kotlin"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../hudhud-sdks-kotlin-core/src/main/resources/META-INF/proguard/hudhud-sdks-kotlin-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("sa.hudhud.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../hudhud-sdks-kotlin-core/src/main/resources/META-INF/proguard/hudhud-sdks-kotlin-core.pro",
