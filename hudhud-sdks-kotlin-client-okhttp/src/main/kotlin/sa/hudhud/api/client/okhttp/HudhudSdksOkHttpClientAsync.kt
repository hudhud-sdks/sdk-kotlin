...
package sa.hudhud.api.client.okhttp
...
import sa.hudhud.api.client.HudhudSdksClientAsyncImpl
...
/**
 * A class that allows building an instance of [HudhudSdksClientAsync] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class HudhudSdksOkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [HudhudSdksClientAsync]. */
        fun builder() = Builder()
         ...
         */
        fun fromEnv(): HudhudSdksClientAsync = builder().fromEnv().build()
    }

    /** A builder for [HudhudSdksOkHttpClientAsync]. */
    class Builder internal constructor() {
         ...
         *
         * Defaults to [sa.hudhud.api.core.jsonMapper]. The default is usually sufficient and rarely
         ...
         *
         * Defaults to the production environment: `https://b.hudhud.sa/v1`.
         */
        ...
        /** JWT Bearer token for authentication. Example: "Bearer <token>" */
        ...
        /**
         * Returns an immutable instance of [HudhudSdksClientAsync].
         *
