...
import com.hudhud_sdks.api.core.http.HttpClient
import com.hudhud_sdks.api.core.http.HttpMethod
import com.hudhud_sdks.api.core.http.HttpRequest
import com.hudhud_sdks.api.core.http.HttpRequestBody
...
class OkHttpClient private constructor(private val okHttpClient: okhttp3.OkHttpClient) :
    ...
    override fun execute(request: HttpRequest, requestOptions: RequestOptions): HttpResponse {
        ...
        return try {
            ...
            throw HudhudSdksIoException("Request failed", e)
        } finally {
            request.body?.close()
        }
    }
    ...
    private fun newCall(request: HttpRequest, requestOptions: RequestOptions): Call {
        ...
        val logLevel =
            when (System.getenv("HUDHUD_SDKS_LOG")?.lowercase()) {
