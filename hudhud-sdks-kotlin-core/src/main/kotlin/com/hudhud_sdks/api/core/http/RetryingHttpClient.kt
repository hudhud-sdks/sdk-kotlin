package com.hudhud_sdks.api.core.http

import com.hudhud_sdks.api.core.RequestOptions
import com.hudhud_sdks.api.core.checkRequired
import com.hudhud_sdks.api.errors.HudhudSdksIoException
...
private constructor(
    ...
    private fun shouldRetry(throwable: Throwable): Boolean =
        // Only retry IOException and HudhudSdksIoException, other exceptions are not intended to be
        // retried.
        throwable is IOException || throwable is HudhudSdksIoException
