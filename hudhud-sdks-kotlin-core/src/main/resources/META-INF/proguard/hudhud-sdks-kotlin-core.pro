...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class sa.hudhud.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class sa.hudhud.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class sa.hudhud.api.** {
    <init>(...);
